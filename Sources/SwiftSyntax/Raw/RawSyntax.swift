...
extension RawSyntax {
  ...
  internal static func parsedToken(
    ...
    let payload = RawSyntaxData.ParsedToken(
      ...
      precondition(kind != .keyword || Keyword(payload.tokenText) != nil || Keyword(misspelling: payload.tokenText) != nil , "If kind is keyword, the text must be a known token kind")
